  ...
  return (
    <section className="py-4 mt-4 lg:mt-60">
      ...
      <div className="sm:w-3/4 lg:w-5/12 mx-auto px-2">
        ...
        <p className="text-center text-bookmark-grey mt-4 leading-[25px] text-grayish-blue  text-custom-sm px-8 lg:text-custom-base">
      ...
      <div className="relative container flex flex-col md:flex-row items-center justify-center mt-12 md:mt-24">
        ...
        <div className="flex justify-center flex-1 mb-10 md:mb-0 z-10">
          <img className="w-5/6 h-5/6 sm:w-3/4 sm:h-3/4 md:w-full md:h-full" src={features[activeTab].image} alt="" />
        </div>
        {/* Content */}
